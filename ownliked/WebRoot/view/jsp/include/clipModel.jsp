...
<%--	Reclip model	--%>
		<div id="PostSuccess" style="display: none;">
			<h2>Recliped to <a href="###">my like this</a></h2>
			<h2>Shared with your followers. <a href="###">See it now</a></h2>
			<h3>Also Cliped to:</h3>
			<div class="boardWrapper">
				<h3><a href="###">Gift idea's</a></h3>
				<h4><a href="###"><img src="view/images/popular/154zt9c.jpg" style="width: 15px; height:15px;"/></a> <a href="###">Callie Locke</a></h4>
				<div class="followBoard">
					<a href="###" class="link"></a>
					<div class="holder">
						<span class="cover">
							<img src="view/images/popular/154zt9c.jpg"/>
						</span>
						<span class="thumbs">
							<img src="view/images/popular/154zt9c.jpg"/>
							<img src="view/images/popular/154zt9c.jpg"/>
					...
					<div class="reFollow">
						<a href="###" class="button13 button whiteButton inlineButton">Follow</a>
					</div>
				</div>
			</div>
		</div>
